      ...
      overlay.innerHTML = `
          <article class="card-popup" style="background: url('${event.featureImage}') center/cover no-repeat">
            ...
            <div class="card-content">
              ...
              <button type="button" class="cancel-registration" style="height: 100px;">Cancel Registration</button>
            </div>
          </article>
        `;
      openPopup();

      // const cancelRegistrationButton = document.querySelectorAll('.cancel-registration')

      // cancelRegistrationButton.forEach((button, index) => {
